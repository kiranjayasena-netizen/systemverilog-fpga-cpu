...
set out [file normalize .stage11_bench_xsim]
...
exec $xelab -debug typical -relax xil_defaultlib.vector_stage11_benchmark_tb -s vector_stage11_benchmark
exec $xsim vector_stage11_benchmark -runall
puts "STAGE11_BENCH_XSIM_COMPLETE"
