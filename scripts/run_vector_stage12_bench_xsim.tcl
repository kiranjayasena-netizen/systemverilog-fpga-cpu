...
set out [file normalize .stage12_bench_xsim]
...
set sources [list [file join $root rtl vector_register_file.sv] [file join $root rtl vector_alu.sv] [file join $root rtl vector_execution_unit.sv] [file join $root rtl vector_instruction_memory.sv] [file join $root rtl vector_memory_instruction_decoder.sv] [file join $root rtl vector_data_memory.sv] [file join $root rtl vector_two_outstanding_prefetch_program_core.sv] [file join $root tb vector_stage12_benchmark_tb.sv]]
cd $out
exec $xvlog -sv -relax -work xil_defaultlib {*}$sources
exec $xelab -debug typical -relax -generic_top LOOKAHEAD_DEPTH=6 xil_defaultlib.vector_stage12_benchmark_tb -s vector_stage12_bench
exec $xsim vector_stage12_bench -runall
puts "STAGE12_BENCH_XSIM_COMPLETE"
