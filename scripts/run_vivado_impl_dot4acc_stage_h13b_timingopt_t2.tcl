...
set TOP_MODULE "fpga_top_pipeline_dot4acc_memopt_h13b_timingopt_t2"
set BITSTREAM_NAME "fpga_top_pipeline_dot4acc_memopt_h13b_timingopt_t2.bit"
...
set flow_rc [catch {
    ...
    read_verilog -sv rtl/cpu_core_pipeline_dot4acc_memopt_h13b_timingopt_t2.sv
    read_verilog -sv rtl/fpga_top_pipeline_dot4acc_memopt_h13b_timingopt_t2.sv
    read_xdc $XDC_FILE
