set PHASE19_LABEL "Phase 20 forward-timing branch-predict copy 119.000 MHz"
set TOP_MODULE "fpga_top_phase20_forwardtiming_mmcm_119"
set REPORT_ROOT "reports/phase20_forwardtiming_mmcm_impl/119"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
