set PHASE19_LABEL "Phase 23 retimed JUMP-cache copy 117.000 MHz"
set TOP_MODULE "fpga_top_phase23_forwardtiming_mmcm_117"
set REPORT_ROOT "reports/phase23_forwardtiming_mmcm_impl/117"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
