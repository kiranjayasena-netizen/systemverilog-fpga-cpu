set PHASE19_LABEL "Phase 21 Phase 20E extension original forward-timing 120.000 MHz"
set TOP_MODULE "fpga_top_phase21_phase20e_120p0"
set REPORT_ROOT "reports/phase21_phase20e_frequency_extension_impl/120p0"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
