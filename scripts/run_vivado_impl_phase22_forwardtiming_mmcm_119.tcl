set PHASE19_LABEL "Phase 22 forward-timing frontend copy 119.000 MHz"
set TOP_MODULE "fpga_top_phase22_forwardtiming_mmcm_119"
set REPORT_ROOT "reports/phase22_forwardtiming_mmcm_impl/119"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
