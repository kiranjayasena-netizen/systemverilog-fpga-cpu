...
set out [file normalize .stage13_xsim]
...
set sources [list [file join $root rtl vector_register_file.sv] [file join $root rtl vector_alu.sv] [file join $root rtl vector_execution_unit.sv] [file join $root rtl vector_instruction_memory.sv] [file join $root rtl vector_memory_instruction_decoder.sv] [file join $root rtl vector_data_memory.sv] [file join $root rtl vector_two_outstanding_prefetch_program_core.sv] [file join $root tb vector_stage13_bottleneck_analysis_tb.sv]]
cd $out
exec $xvlog -sv -relax -work xil_defaultlib {*}$sources
exec $xelab -debug typical -relax xil_defaultlib.vector_stage13_bottleneck_analysis_tb -s vector_stage13_analysis
exec $xsim vector_stage13_analysis -runall
puts "STAGE13_ANALYSIS_XSIM_COMPLETE"
