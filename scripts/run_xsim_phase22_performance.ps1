...
Invoke-XSimTest `
    -Top "tb_phase22_forwardtiming_correctness" `
    -SnapshotPrefix "phase22_forwardtiming_correctness" `
    -Sources ($commonSources + @("tb/tb_phase22_forwardtiming_correctness.sv"))

Invoke-XSimTest `
    -Top "tb_phase22_final_benchmark" `
    -SnapshotPrefix "phase22_final_benchmark" `
    -Sources ($commonSources + @("tb/tb_phase22_final_benchmark.sv"))

Write-Host ""
Write-Host "Phase 22 XSim tests completed."
