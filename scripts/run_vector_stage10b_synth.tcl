...
report_utilization -hierarchical -file $OUT_DIR/stage10b_synth_utilization.rpt
report_utilization -hierarchical -cells [get_cells core] -file $OUT_DIR/stage10b_synth_hierarchy.rpt
report_ram_utilization -file $OUT_DIR/stage10b_synth_memory_mapping.rpt
puts "STAGE10B_SYNTHESIS_COMPLETE"
