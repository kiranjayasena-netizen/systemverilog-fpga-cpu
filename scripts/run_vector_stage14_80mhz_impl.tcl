...
file mkdir $out
create_project stage14_impl .stage14_impl -part xc7a35tcpg236-1 -force
...
add_files -fileset constrs_1 -norecurse [file join $root constraints vector_load_overlap_stage14_80mhz.xdc]
...
wait_on_run impl_1
open_run impl_1
report_utilization -file [file join $out stage14_postroute_utilization.rpt]
report_timing_summary -file [file join $out stage14_80mhz_timing_summary.rpt]
report_timing -max_paths 10 -file [file join $out stage14_worst_paths.rpt]
close_project
puts "STAGE14_IMPL_COMPLETE"
