...
Invoke-XsimTest `
    -Name "Phase 10G BRAM-aware multi-cycle CPU full programs" `
    -Sources @("rtl/cpu_defs_pkg.sv", "rtl/bram_instr_mem.sv", "rtl/bram_data_mem.sv", "rtl/cpu_core_multicycle_bram.sv", "tb/tb_cpu_core_multicycle_bram_full_programs.sv") `
    -Top "tb_cpu_core_multicycle_bram_full_programs" `
    -Snapshot "tb_cpu_core_multicycle_bram_full_programs_sim"

Invoke-XsimTest `
    -Name "Phase 11A BRAM-aware prefetch CPU basic" `
    -Sources @("rtl/cpu_defs_pkg.sv", "rtl/bram_instr_mem.sv", "rtl/bram_data_mem.sv", "rtl/cpu_core_multicycle_bram_prefetch.sv", "tb/tb_cpu_core_multicycle_bram_prefetch_basic.sv") `
    -Top "tb_cpu_core_multicycle_bram_prefetch_basic" `
    -Snapshot "tb_cpu_core_multicycle_bram_prefetch_basic_sim"

Invoke-XsimTest `
    -Name "Phase 11B BRAM-aware prefetch CPU full programs" `
    -Sources @("rtl/cpu_defs_pkg.sv", "rtl/bram_instr_mem.sv", "rtl/bram_data_mem.sv", "rtl/cpu_core_multicycle_bram_prefetch.sv", "tb/tb_cpu_core_multicycle_bram_prefetch_full_programs.sv") `
    -Top "tb_cpu_core_multicycle_bram_prefetch_full_programs" `
