# One clean default-flow Stage G1 implementation of the fixed DOT4ACC CPU.
#
# Usage:
...
set TOP_MODULE "fpga_top_pipeline_dot4acc_timingopt"
set BITSTREAM_NAME "fpga_top_pipeline_dot4acc_timingopt.bit"
...
set flow_rc [catch {
    ...
    read_verilog -sv rtl/cpu_core_pipeline_dot4acc_timingopt.sv
    read_verilog -sv rtl/fpga_top_pipeline_dot4acc_timingopt.sv
    read_xdc $XDC_FILE
