...
file mkdir $out
create_project stage11_depth6_synth .stage11_depth6_synth -part xc7a35tcpg236-1 -force
...
wait_on_run synth_1
open_run synth_1
report_utilization -file [file join $out stage11_depth6_synth_utilization.rpt]
close_project
puts "STAGE11_DEPTH6_SYNTH_COMPLETE"
