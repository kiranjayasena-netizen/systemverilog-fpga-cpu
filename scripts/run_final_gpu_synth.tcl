...
file mkdir $out
create_project final_gpu_synth .final_gpu_synth -part xc7a35tcpg236-1 -force
...
wait_on_run synth_1
open_run synth_1
report_utilization -file [file join $out final_gpu_synth_utilization.rpt]
close_project
puts "FINAL_GPU_SYNTH_COMPLETE"
