...
Invoke-XSimTest `
    -Top "tb_phase24_forwardtiming_correctness" `
    -SnapshotPrefix "phase24_forwardtiming_correctness" `
    -Sources ($commonSources + @("tb/tb_phase24_forwardtiming_correctness.sv"))

Invoke-XSimTest `
    -Top "tb_phase24_final_benchmark" `
    -SnapshotPrefix "phase24_final_benchmark" `
    -Sources ($commonSources + @("tb/tb_phase24_final_benchmark.sv"))

Write-Host ""
Write-Host "Phase 24 XSim tests completed."
