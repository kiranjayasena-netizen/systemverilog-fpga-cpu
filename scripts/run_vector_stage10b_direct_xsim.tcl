...
set out [file normalize .stage10b_direct_xsim]
...
set sources [list [file join $root rtl vector_register_file.sv] [file join $root rtl vector_alu.sv] [file join $root rtl vector_execution_unit.sv] [file join $root rtl vector_instruction_memory.sv] [file join $root rtl vector_memory_instruction_decoder.sv] [file join $root rtl vector_data_memory.sv] [file join $root rtl vector_alu_prefetch_program_core.sv] [file join $root tb vector_alu_prefetch_program_core_tb.sv]]
cd $out
exec $xvlog -sv -relax -work xil_defaultlib {*}$sources
exec $xelab -debug typical -relax xil_defaultlib.vector_alu_prefetch_program_core_tb -s vector_stage10b_direct
exec $xsim vector_stage10b_direct -runall
puts "STAGE10B_DIRECT_XSIM_COMPLETE"
