...
set out [file normalize .stage11_depth6_xsim]
...
exec $xelab -debug typical -relax -generic_top LOOKAHEAD_DEPTH=6 xil_defaultlib.vector_extended_lookahead_program_core_tb -s vector_extended_lookahead_depth6
exec $xsim vector_extended_lookahead_depth6 -runall
puts "STAGE11_DEPTH6_XSIM_COMPLETE"
