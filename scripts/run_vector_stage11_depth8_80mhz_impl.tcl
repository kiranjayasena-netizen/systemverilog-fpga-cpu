...
file mkdir $out
create_project stage11_depth8_impl .stage11_depth8_impl -part xc7a35tcpg236-1 -force
...
wait_on_run impl_1
open_run impl_1
report_utilization -file [file join $out stage11_depth8_postroute_utilization.rpt]
report_timing_summary -file [file join $out stage11_depth8_80mhz_timing_summary.rpt]
report_timing -max_paths 10 -file [file join $out stage11_depth8_worst_paths.rpt]
close_project
puts "STAGE11_DEPTH8_IMPL_COMPLETE"
