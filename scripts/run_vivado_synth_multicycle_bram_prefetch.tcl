# Phase 11C synthesis script for the separate BRAM-aware prefetch FPGA top.
#
...
# fpga_top_multicycle_bram_prefetch and writes separate Phase 11C reports.
...
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_multicycle_bram_prefetch_synth_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_multicycle_bram_prefetch_synth_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_multicycle_bram_prefetch_synth_worst_paths.rpt
report_power -file $REPORT_ROOT/power/fpga_top_multicycle_bram_prefetch_synth_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_multicycle_bram_prefetch_synth.dcp
