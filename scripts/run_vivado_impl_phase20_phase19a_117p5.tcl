set PHASE19_LABEL "Phase 20 Phase 19A extension original forward-timing 117.500 MHz"
set TOP_MODULE "fpga_top_phase20_phase19a_117p5"
set REPORT_ROOT "reports/phase20_phase19a_frequency_extension_impl/117p5"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
