set PHASE19_LABEL "Phase 22 forward-timing frontend copy 115.000 MHz"
set TOP_MODULE "fpga_top_phase22_forwardtiming_mmcm_115"
set REPORT_ROOT "reports/phase22_forwardtiming_mmcm_impl/115"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
