# Phase 18 benchmark-aligned high-frequency MMCM implementation for the
...
# reports/phase18_benchmark_aligned_impl/ and should not be committed wholesale.

set FPGA_PART "xc7a35tcpg236-1"
set TOP_MODULE "fpga_top_phase18_forwardtiming_mmcm_benchmark"
set INPUT_PERIOD "10.000"
set REPORT_ROOT "reports/phase18_benchmark_aligned_impl"
...
puts "Phase 18 benchmark-aligned MMCM implementation"
puts "  Top:          $TOP_MODULE"
puts "  Input period: $INPUT_PERIOD ns"
puts "  CPU clock:    115.000 MHz from RTL-instantiated MMCM"
puts "  Benchmark:    programs/final_benchmark.mem"
...
read_verilog -sv rtl/fpga_top_phase18_forwardtiming_mmcm_benchmark.sv

set phase18_xdc "$REPORT_ROOT/constraints/phase18_forwardtiming_mmcm_benchmark_basys3.xdc"
set xdc [open $phase18_xdc "w"]
...
report_clocks -file $REPORT_ROOT/timing/fpga_top_phase18_forwardtiming_mmcm_benchmark_clocks.rpt
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_phase18_forwardtiming_mmcm_benchmark_impl_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_phase18_forwardtiming_mmcm_benchmark_impl_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_phase18_forwardtiming_mmcm_benchmark_impl_worst_paths.rpt
report_route_status -file $REPORT_ROOT/route/fpga_top_phase18_forwardtiming_mmcm_benchmark_route_status.rpt
report_power -file $REPORT_ROOT/power/fpga_top_phase18_forwardtiming_mmcm_benchmark_impl_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_phase18_forwardtiming_mmcm_benchmark_impl.dcp
write_bitstream -force $REPORT_ROOT/bitstreams/fpga_top_phase18_forwardtiming_mmcm_benchmark.bit

set timing_summary [report_timing_summary -return_string]
puts "Phase 18 timing summary excerpt:"
...
puts "Phase 18 bitstream path: $REPORT_ROOT/bitstreams/fpga_top_phase18_forwardtiming_mmcm_benchmark.bit"
