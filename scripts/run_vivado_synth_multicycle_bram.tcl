# Phase 10H synthesis script for the separate BRAM-aware multi-cycle FPGA top.
#
...
# fpga_top_multicycle flow. It synthesizes fpga_top_multicycle_bram and writes
# separate Phase 10H reports.
...
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_multicycle_bram_synth_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_multicycle_bram_synth_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_multicycle_bram_synth_worst_paths.rpt
report_power -file $REPORT_ROOT/power/fpga_top_multicycle_bram_synth_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_multicycle_bram_synth.dcp
