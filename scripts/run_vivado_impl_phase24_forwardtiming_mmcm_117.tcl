set PHASE19_LABEL "Phase 24 frontend-split copy 117.000 MHz"
set TOP_MODULE "fpga_top_phase24_forwardtiming_mmcm_117"
set REPORT_ROOT "reports/phase24_forwardtiming_mmcm_impl/117"
set PHASE19_SOURCES {
    rtl/cpu_defs_pkg.sv
