...
set out_dir [expr {[info exists ::env(STAGE31_BUILD_ROOT)] ? [file normalize $::env(STAGE31_BUILD_ROOT)] : [file join $root ".ai_cpu_stage31_optimized"]}]
create_project -force ai_cpu_stage31_optimized $out_dir -part $part
set src [list \
...
set_property top basys3_ai_cpu_stage31_optimized_top [current_fileset]
...
file copy -force [file join $out_dir ai_cpu_stage31_optimized.runs impl_1 basys3_ai_cpu_stage31_optimized_top.bit] [file join $out_dir ai_cpu_stage31_optimized.bit]
open_run impl_1
