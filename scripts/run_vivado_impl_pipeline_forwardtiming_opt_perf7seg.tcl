# Phase 17C Basys 3 hardware MIPS wrapper for the optimised forward-timing CPU.
#
# Run from the repository root:
#   vivado -mode batch -source scripts/run_vivado_impl_pipeline_forwardtiming_opt_perf7seg.tcl
#
# Generated reports, checkpoints and bitstreams are written under
# reports/phase17c_forwardtiming_opt_perf7seg_impl/ and should not be committed wholesale.

set FPGA_PART "xc7a35tcpg236-1"
set TOP_MODULE "fpga_top_pipeline_forwardtiming_opt_perf7seg"
set PERIOD "10.000"
set REPORT_ROOT "reports/phase17c_forwardtiming_opt_perf7seg_impl"
...
puts "Phase 17C optimised forward-timing MIPS-display implementation"
puts "  Top:     $TOP_MODULE"
...
read_verilog -sv rtl/fpga_top_pipeline_forwardtiming_opt_perf7seg.sv

set profile_xdc "$REPORT_ROOT/constraints/forwardtiming_opt_perf7seg_basys3.xdc"
...
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_pipeline_forwardtiming_opt_perf7seg_impl_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_pipeline_forwardtiming_opt_perf7seg_impl_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_pipeline_forwardtiming_opt_perf7seg_impl_worst_paths.rpt
report_route_status -file $REPORT_ROOT/route/fpga_top_pipeline_forwardtiming_opt_perf7seg_route_status.rpt
report_power -file $REPORT_ROOT/power/fpga_top_pipeline_forwardtiming_opt_perf7seg_impl_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_pipeline_forwardtiming_opt_perf7seg_impl.dcp
write_bitstream -force $REPORT_ROOT/bitstreams/fpga_top_pipeline_forwardtiming_opt_perf7seg.bit

set timing_summary [report_timing_summary -return_string]
puts "Phase 17C opt perf7seg timing summary excerpt:"
...
puts "Phase 17C opt perf7seg bitstream path: $REPORT_ROOT/bitstreams/fpga_top_pipeline_forwardtiming_opt_perf7seg.bit"
