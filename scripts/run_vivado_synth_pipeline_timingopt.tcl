# Phase 13C timingopt pipeline synthesis script for the separate pipelined FPGA top.
#
# Run from the repository root in Vivado Tcl mode:
#   vivado -mode batch -source scripts/run_vivado_synth_pipeline_timingopt.tcl
...
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_pipeline_timingopt_synth_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_pipeline_timingopt_synth_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_pipeline_timingopt_synth_worst_paths.rpt
report_power -file $REPORT_ROOT/power/fpga_top_pipeline_timingopt_synth_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_pipeline_timingopt_synth.dcp
