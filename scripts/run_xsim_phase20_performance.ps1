...
Invoke-XSimTest `
    -Top "tb_phase20_forwardtiming_correctness" `
    -SnapshotPrefix "phase20_forwardtiming_correctness" `
    -Sources ($commonSources + @("tb/tb_phase20_forwardtiming_correctness.sv"))

Invoke-XSimTest `
    -Top "tb_phase20_final_benchmark" `
    -SnapshotPrefix "phase20_final_benchmark" `
    -Sources ($commonSources + @("tb/tb_phase20_final_benchmark.sv"))

Write-Host ""
Write-Host "Phase 20 XSim tests completed."
