# One clean default-flow Stage F implementation of the fixed DOT4ACC CPU.
#
# Usage:
#   vivado -mode batch -source scripts/run_vivado_impl_dot4acc_stage_f.tcl \
...
set TOP_MODULE "fpga_top_pipeline_dot4acc_wb"
set BITSTREAM_NAME "fpga_top_pipeline_dot4acc_wb.bit"
...
set flow_rc [catch {
    ...
    read_verilog -sv rtl/cpu_core_pipeline_dot4acc_wb.sv
    read_verilog -sv rtl/fpga_top_pipeline_dot4acc_wb.sv
    read_xdc $XDC_FILE
...
if {$flow_rc != 0} {
    puts stderr "DOT4ACC_STAGE_F_RUN_FAILED: $flow_error"
    exit 1
}

puts "DOT4ACC_STAGE_F_RUN_COMPLETED: id=$IMPLEMENTATION_IDENTIFIER"
exit 0
