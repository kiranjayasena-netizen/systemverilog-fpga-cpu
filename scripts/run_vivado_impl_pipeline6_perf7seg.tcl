# Phase 16A Basys 3 7-segment hardware MIPS counter implementation flow.
#
# Builds rtl/fpga_top_pipeline6_perf7seg.sv at the board 100 MHz clock.
# Generated reports, checkpoints and bitstreams are written under
# reports/phase16a_perf7seg_impl/ and should not be committed wholesale.

set FPGA_PART "xc7a35tcpg236-1"
set TOP_MODULE "fpga_top_pipeline6_perf7seg"
set PERIOD "10.000"
set REPORT_ROOT "reports/phase16a_perf7seg_impl"
...
puts "Phase 16A Basys 3 hardware MIPS counter implementation"
puts "  Top:      $TOP_MODULE"
...
read_verilog -sv rtl/fpga_top_pipeline6_perf7seg.sv

set perf_xdc "$REPORT_ROOT/constraints/pipeline6_perf7seg_basys3.xdc"
set xdc [open $perf_xdc "w"]
...
report_utilization -file $REPORT_ROOT/utilisation/fpga_top_pipeline6_perf7seg_impl_utilization.rpt
report_timing_summary -file $REPORT_ROOT/timing/fpga_top_pipeline6_perf7seg_impl_timing_summary.rpt
report_timing -max_paths 10 -path_type full -file $REPORT_ROOT/timing/fpga_top_pipeline6_perf7seg_impl_worst_paths.rpt
report_route_status -file $REPORT_ROOT/route/fpga_top_pipeline6_perf7seg_route_status.rpt
report_power -file $REPORT_ROOT/power/fpga_top_pipeline6_perf7seg_impl_power.rpt

write_checkpoint -force $REPORT_ROOT/checkpoints/fpga_top_pipeline6_perf7seg_impl.dcp
write_bitstream -force $REPORT_ROOT/bitstreams/fpga_top_pipeline6_perf7seg.bit

set timing_summary [report_timing_summary -return_string]
puts "Phase 16A timing summary excerpt:"
...
puts "Phase 16A bitstream path: $REPORT_ROOT/bitstreams/fpga_top_pipeline6_perf7seg.bit"
