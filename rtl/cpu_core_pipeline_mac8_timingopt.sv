...
// Timing experiment derived from cpu_core_pipeline_full. Frontend payload
// registers retain don't-care data when their valid bit is cleared, removing
// redirect/flush control from those payload-register inputs.
module cpu_core_pipeline_mac8_timingopt #(
