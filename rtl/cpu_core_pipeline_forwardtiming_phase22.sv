...
module cpu_core_pipeline_forwardtiming_phase22 #(
    ...
    assign jump_cache_fetch_hit = jump_cache_valid &&
                                  fetch_pending_valid &&
                                  !fetch_buffer_valid &&
                                  !jump_response_pending &&
                                  (fetch_pending_pc == jump_cache_pc);
    ...
    always_comb begin
        ...
        end else if (jump_cache_fetch_hit) begin
            next_instruction_addr = jump_cache_target;
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            if (ex_redirect_taken) begin
                ...
                if (jump_cache_fetch_hit) begin
                    fetch_pending_pc            <= jump_cache_target;
                    fetch_pending_valid         <= 1'b1;
                    fetch_pc                    <= jump_cache_target + 32'd4;
