module fpga_top_multicycle_bram_prefetch_ctrlopt #(
    ...
    always_comb begin
        // LED debug map:
        // led[3:0]   = PC word index from pc[5:2]
        // led[7:4]   = decoded opcode
        // led[8]     = valid instruction
        // led[9]     = register write enable
        // led[10]    = data-memory write enable
        // led[13:11] = control-flow-optimised prefetch CPU FSM state
        // led[14]    = prefetch buffer valid
        // led[15]    = low ALU result bit
        led[3:0]   = pc[5:2];
        led[7:4]   = opcode_reg;
        led[8]     = valid_instr;
        led[9]     = reg_write;
