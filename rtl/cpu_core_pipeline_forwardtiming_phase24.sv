...
module cpu_core_pipeline_forwardtiming_phase24 #(
    ...
    logic [31:0] imem_request_pc_reg;
    logic        imem_request_valid_reg;
    ...
    assign fetch_request_pc    = imem_request_pc_reg;
    assign fetch_request_valid = imem_request_valid_reg;
    ...
    assign instruction_addr = imem_request_pc_reg;
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            imem_request_pc_reg      <= 32'h0000_0000;
            imem_request_valid_reg   <= 1'b0;
            ...
            if (ex_redirect_taken) begin
                ...
                imem_request_valid_reg   <= 1'b0;
                redirect_pending_valid   <= 1'b1;
                redirect_pending_target  <= id_jump_target;
                jump_response_pending    <= 1'b0;
                ...
                fetch_buffer_valid       <= 1'b0;
                fetch_pending_valid      <= 1'b0;
                imem_request_pc_reg      <= redirect_pending_target;
                imem_request_valid_reg   <= 1'b1;
                ...
                fetch_pending_pc       <= imem_request_pc_reg;
                fetch_pending_valid    <= imem_request_valid_reg;
                imem_request_valid_reg <= 1'b0;
