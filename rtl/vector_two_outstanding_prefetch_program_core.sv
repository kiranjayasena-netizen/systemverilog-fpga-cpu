// Stage 12: Stage 11 depth-6 dual-entry prefetch with two outstanding reads.
// The Stage 10A source is intentionally left unchanged; this is an independent core.
module vector_two_outstanding_prefetch_program_core #(
 ...
 logic prefetch_issue,prefetch_hit0,prefetch_hit1,prefetch_hit; logic [1:0] outstanding_count; logic response0_due;
  ...
  logic store_kill_pending0,store_kill_pending1,external_invalidation;
