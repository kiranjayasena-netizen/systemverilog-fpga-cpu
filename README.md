...
- [Phase 17A forward-timing profiler](reports/phase17a_forwardtiming_profile.md) documents the Phase 13 hardware MIPS profiling wrapper and bitstream.
- [Phase 17B bottleneck analysis](reports/phase17b_forwardtiming_bottleneck_analysis.md) records the confirmed 87 MIPS, CPI x100 0115 and control-flush x100 1250 board readings.
- [Phase 17C optimisation experiment](reports/phase17c_forwardtiming_optimisation.md) records the separate direct EX-stage branch-target request experiment, its small simulation CPI improvement and its failed 10 ns timing result.
...
- [Phase 17E high-frequency hardware test plan](reports/phase17e_high_frequency_hardware_test_plan.md) records the planning that led to the MMCM hardware measurement phase.
- [Phase 17E MMCM high-frequency MIPS test](reports/phase17e_mmcm_high_frequency_mips_test.md) documents the 115 MHz MMCM wrapper, timing-clean implementation and confirmed `0100` MIPS board reading.
- [Hardware evidence checklist](docs/hardware_evidence_checklist.md) lists the photos/video stills to capture for the key Phase 13, Phase 16 and Phase 17 board evidence.
...
- Phase 17A hardware profiling wrapper for the Phase 13 forward-timing CPU
...
- Phase 17E MMCM high-frequency hardware MIPS test for the original Phase 13 forward-timing CPU, confirmed on board with a `0100` MIPS display
...
- Capture photo/video evidence for the Phase 17E `0100` MIPS display, CPI x100 display, control-flush display and LED0 MMCM lock indication
