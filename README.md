...
- The full local Vivado XSim regression now passes through Phase 8F.
...
- Phase 8G synthesis and timing comparison between the Phase 7 baseline and the separate Phase 8 multi-cycle CPU
