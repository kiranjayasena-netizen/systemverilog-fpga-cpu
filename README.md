...
The repository contains the verified four-lane SIMD GPU through Stage 14. The selected core is
...
`docs/`. GPU v1.0 physical validation completed on Basys 3 at 80 MHz through
the production UART interface, including all four benchmark programs,
restart/consecutive operation, and 100-run stability testing.
