...
module tb_phase21_final_benchmark;
    ...
    cpu_core_pipeline_forwardtiming_phase21 #(
    ...
    initial begin
        ...
        for (int unsigned i = 0; i < MEASURE_CYCLES; i++) begin
            ...
            if (no_retire_cycles > 1_000) begin
                $fatal(1, "Phase 21 benchmark stopped retiring instructions for %0d cycles at fetch_pc=%08h",
        ...
        if (retired_count == 0) begin
            $fatal(1, "Phase 21 benchmark retired zero instructions");
        end
        ...
        $display("PHASE 21 FINAL BENCHMARK SUMMARY");
        ...
        $display("  predicted MIPS @119 MHz   = %0.3f", 119.000 / cpi);
        ...
        $display("PHASE 21 FINAL BENCHMARK TEST PASSED");
        $finish;
    end
endmodule
