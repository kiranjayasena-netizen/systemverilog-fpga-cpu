...
module tb_cpu_core_pipeline_jumpfast;
    ...
    initial begin
        $dumpfile("tb_cpu_core_pipeline_jumpfast.vcd");
        $dumpvars(0, tb_cpu_core_pipeline_jumpfast);
        ...
        if (tests_failed == 0) begin
            $display("PHASE 13A JUMPFAST PIPELINE TEST PASSED");
        end else begin
            $display("PHASE 13A JUMPFAST PIPELINE TEST FAILED");
            $fatal(1, "Phase 13A jumpfast pipeline test failed");
        end
