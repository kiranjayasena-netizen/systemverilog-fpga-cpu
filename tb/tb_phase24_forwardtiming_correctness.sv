...
module tb_phase24_forwardtiming_correctness;
    ...
    initial begin
        ...
        //   loop branch, and a repeated JUMP pattern for the Phase 24
        //   frontend split redirect path
        ...
        $display("PHASE 24 FRONTEND SPLIT CORRECTNESS SUMMARY: tests_run=%0d tests_failed=%0d",
                 tests_run, tests_failed);
        if (tests_failed != 0) begin
            $fatal(1, "PHASE 24 FRONTEND SPLIT CORRECTNESS TEST FAILED");
        end

        $display("PHASE 24 FRONTEND SPLIT CORRECTNESS TEST PASSED");
        $finish;
    end
endmodule
