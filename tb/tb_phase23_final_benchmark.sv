...
module tb_phase23_final_benchmark;
    ...
    initial begin
        ...
        for (int unsigned i = 0; i < MEASURE_CYCLES; i++) begin
            ...
            if (no_retire_cycles > 1_000) begin
                $fatal(1, "Phase 23 benchmark stopped retiring instructions for %0d cycles at fetch_pc=%08h",
        ...
        if (retired_count == 0) begin
            $fatal(1, "Phase 23 benchmark retired zero instructions");
        end
        ...
        $display("PHASE 23 FINAL BENCHMARK SUMMARY");
        ...
        $display("PHASE 23 FINAL BENCHMARK TEST PASSED");
        $finish;
    end
endmodule
