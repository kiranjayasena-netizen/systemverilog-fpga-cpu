...
module tb_phase21_forwardtiming_correctness;
    ...
    initial begin
        ...
        //   loop branch, which the Phase 21 CPU predicts taken
        ...
        $display("PHASE 21 FORWARDTIMING CORRECTNESS SUMMARY: tests_run=%0d tests_failed=%0d",
                 tests_run, tests_failed);
        if (tests_failed != 0) begin
            $fatal(1, "PHASE 21 FORWARDTIMING CORRECTNESS TEST FAILED");
        end

        $display("PHASE 21 FORWARDTIMING CORRECTNESS TEST PASSED");
        $finish;
    end
endmodule
