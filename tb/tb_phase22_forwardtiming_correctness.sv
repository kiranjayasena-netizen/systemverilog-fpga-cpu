...
module tb_phase22_forwardtiming_correctness;
    ...
    initial begin
        ...
        //   loop branch, and a repeated JUMP pattern for the Phase 22
        ...
        $display("PHASE 22 FORWARDTIMING CORRECTNESS SUMMARY: tests_run=%0d tests_failed=%0d",
                 tests_run, tests_failed);
        if (tests_failed != 0) begin
            $fatal(1, "PHASE 22 FORWARDTIMING CORRECTNESS TEST FAILED");
        end

        $display("PHASE 22 FORWARDTIMING CORRECTNESS TEST PASSED");
        $finish;
    end
endmodule
