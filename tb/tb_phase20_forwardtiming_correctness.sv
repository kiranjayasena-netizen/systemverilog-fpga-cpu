...
module tb_phase20_forwardtiming_correctness;
    ...
    cpu_core_pipeline_forwardtiming_phase20 #(
    ...
    initial begin
        ...
        //   loop branch, which the Phase 20 CPU predicts taken
        ...
        $display("PHASE 20 FORWARDTIMING CORRECTNESS SUMMARY: tests_run=%0d tests_failed=%0d",
                 tests_run, tests_failed);
        if (tests_failed != 0) begin
            $fatal(1, "PHASE 20 FORWARDTIMING CORRECTNESS TEST FAILED");
        end

        $display("PHASE 20 FORWARDTIMING CORRECTNESS TEST PASSED");
        $finish;
    end
endmodule
