`timescale 1ns/1ps
module vector_extended_lookahead_program_core_tb #(parameter integer LOOKAHEAD_DEPTH=6);
 ...
 vector_extended_lookahead_program_core #(.LOOKAHEAD_DEPTH(LOOKAHEAD_DEPTH)) dut(.*);
