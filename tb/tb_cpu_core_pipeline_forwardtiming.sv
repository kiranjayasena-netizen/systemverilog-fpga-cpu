...
module tb_cpu_core_pipeline_forwardtiming;
    ...
    initial begin
        $dumpfile("tb_cpu_core_pipeline_forwardtiming.vcd");
        $dumpvars(0, tb_cpu_core_pipeline_forwardtiming);
        ...
        if (tests_failed == 0) begin
            $display("Phase 13E forwardtiming PIPELINE TEST PASSED");
        end else begin
            $display("Phase 13E forwardtiming PIPELINE TEST FAILED");
            $fatal(1, "Phase 13E forwardtiming pipeline test failed");
        end
